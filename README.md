...
running downward: one hour behind, three ahead, notched every fifteen minutes, with a
pointer at the quarter mark that never moves. The ruler slides past it as the clock
advances. Appointments are bands spanning their duration; tasks and reminders are wedges
poking inward off the ruler. Beside it, level with the pointer, a digital clock — then
the date, a countdown, the next turn, and whatever is running out, stacked downward.
