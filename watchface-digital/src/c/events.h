...
// strip can only usefully render a couple of dozen markers anyway. The table
...
// ordinary way these faces are used, and an in-RAM table meant the strip came back
...
// inside the window's own reach forward — 3 h on the rectangles, 3.5 h on gabbro, so
